...
## Version Notes
Version 12 adds the option to hide the pop-up when you buy an item with an alternate currency, like honor or anima.

Version 11 adds the option to hide the pop-up when you try to equip an item you can return to a vendor for a refund.
